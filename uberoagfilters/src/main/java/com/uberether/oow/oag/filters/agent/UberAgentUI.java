 ...
 * @author msamblanet
 */
public class UberAgentUI extends DefaultGUIFilter {
    /**
     ...
     */
    private static final String IMAGE_KEY = "uberAgentFilter";
    static {
        Images.getImageRegistry().put(IMAGE_KEY, 
                Images.createDescriptor(UberAgentUI.class, "uber.gif"));
    }
